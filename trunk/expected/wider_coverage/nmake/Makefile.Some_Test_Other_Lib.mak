...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /MDd /GR /Gy /Fd".\other_libd.pdb" /D _DEBUG /D WIN32 /D _WINDOWS /FD /c
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /GR /Gy /MDd /Fd".\other_libsd.pdb" /D _DEBUG /D WIN32 /D _WINDOWS /FD /c
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -DNDEBUG -DACE_HAS_MFC=1 -DACE_DOESNT_INSTANTIATE_NONSTATIC_OBJECT_MANAGER -DWIN32 -D_WINDOWS -f "Makefile.Some_Test_Other_Lib.dep" "other_lib.cpp"
!ENDIF
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -D_DEBUG -DACE_HAS_MFC=1 -DACE_DOESNT_INSTANTIATE_NONSTATIC_OBJECT_MANAGER -DWIN32 -D_WINDOWS -f "Makefile.Some_Test_Other_Lib.dep" "other_lib.cpp"
!ENDIF
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /MDd /GR /Gy /Fd".\other_libmfcd.pdb" /D _DEBUG /D ACE_HAS_MFC=1 /D ACE_DOESNT_INSTANTIATE_NONSTATIC_OBJECT_MANAGER /D WIN32 /D _WINDOWS /FD /c
