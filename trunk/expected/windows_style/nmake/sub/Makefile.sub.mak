...
ALL : "$(INTDIR)" "$(OUTDIR)" DEPENDCHECK $(GENERATED_DIRTY) "$(INSTALLDIR)\sub.exe"
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /MDd /GR /Gy /Fd"$(INTDIR)/" /I ".." /D _DEBUG /D WIN32 /D _CONSOLE  /c
...
"$(INSTALLDIR)\sub.exe" : $(DEF_FILE) $(LINK32_OBJS)
	$(LINK32) @<<
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /O2 /W3 /EHsc /MD /GR /I ".." /D NDEBUG /D WIN32 /D _CONSOLE  /c
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /MDd /GR /Gy /Fd"$(INTDIR)/" /I ".." /D _DEBUG /D WIN32 /D _CONSOLE /D BASIC_AS_STATIC_LIBS  /c
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /O2 /W3 /EHsc /MD /GR /I ".." /D NDEBUG /D WIN32 /D _CONSOLE /D BASIC_AS_STATIC_LIBS  /c
