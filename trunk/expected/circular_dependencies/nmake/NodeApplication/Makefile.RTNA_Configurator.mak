...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.RTNA_Configurator.mak" CFG="Win32 Debug"
!MESSAGE
...
OUTDIR=.
INTDIR=Debug\RTNA_Configurator\I386

ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\CIAO_RTNA_Configuratord.lib"
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHs /Zi /MDd /GR /Gy /Fd".\CIAO_RTNA_Configuratord.pdb" /D _DEBUG /D WIN32 /D _WINDOWS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"


LINK32=link.exe -lib
LINK32_FLAGS=/nologo /machine:I386 /out:".\CIAO_RTNA_Configuratord.lib"
LINK32_OBJS= \
	"$(INTDIR)\foo.obj"

"$(OUTDIR)\CIAO_RTNA_Configuratord.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
OUTDIR=.
INTDIR=Release\RTNA_Configurator\I386

ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\CIAO_RTNA_Configurator.lib"
...
LINK32=link.exe -lib
LINK32_FLAGS=/nologo /machine:I386 /out:".\CIAO_RTNA_Configurator.lib"
LINK32_OBJS= \
	"$(INTDIR)\foo.obj"

"$(OUTDIR)\CIAO_RTNA_Configurator.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.
INTDIR=Static_Debug\RTNA_Configurator\I386

ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\CIAO_RTNA_Configuratorsd.lib"
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHs /Zi /GR /Gy /MDd /Fd".\CIAO_RTNA_Configuratorsd.pdb" /D _DEBUG /D WIN32 /D _WINDOWS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"


LINK32=link.exe -lib
LINK32_FLAGS=/nologo /machine:I386 /out:".\CIAO_RTNA_Configuratorsd.lib"
LINK32_OBJS= \
	"$(INTDIR)\foo.obj"

"$(OUTDIR)\CIAO_RTNA_Configuratorsd.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
OUTDIR=.
INTDIR=Static_Release\RTNA_Configurator\I386

ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\CIAO_RTNA_Configurators.lib"
...
LINK32=link.exe -lib
LINK32_FLAGS=/nologo /machine:I386 /out:".\CIAO_RTNA_Configurators.lib"
LINK32_OBJS= \
	"$(INTDIR)\foo.obj"

"$(OUTDIR)\CIAO_RTNA_Configurators.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
!IF EXISTS("Makefile.RTNA_Configurator.dep")
!INCLUDE "Makefile.RTNA_Configurator.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.RTNA_Configurator.dep")
	@echo Using "Makefile.RTNA_Configurator.dep"
!ELSE
	@echo Warning: cannot find "Makefile.RTNA_Configurator.dep"
!ENDIF
!ENDIF
