...
ALL : DEPENDCHECK $(GENERATED_DIRTY) ".\foo_cd.dll"
...
".\foo_cd.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : DEPENDCHECK $(GENERATED_DIRTY) ".\foo_c.dll"
...
".\foo_c.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\foo_csd.lib"
...
"$(OUTDIR)\foo_csd.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
...
ALL : DEPENDCHECK $(GENERATED_DIRTY) "$(OUTDIR)\foo_cs.lib"
...
"$(OUTDIR)\foo_cs.lib" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
