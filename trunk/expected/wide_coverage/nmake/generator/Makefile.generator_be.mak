...
CPP=cl.exe
CPP_COMMON=/nologo /Ob0 /W3 /Gm /EHs /Zi /MDd /GR /Gy /Fd"$(INTDIR)/" /D _DEBUG /D WIN32 /D _WINDOWS /D GENERATOR_BE_BUILD_DLL /FD /c
...
CPP=cl.exe
CPP_COMMON=/nologo /O2 /W3 /EHs /MD /GR /D NDEBUG /D WIN32 /D _WINDOWS /D GENERATOR_BE_BUILD_DLL /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"
...
CPP=cl.exe
CPP_COMMON=/nologo /Ob0 /W3 /Gm /EHs /Zi /GR /Gy /MDd /Fd"..\lib\generator_besd.pdb" /D _DEBUG /D WIN32 /D _WINDOWS /D GENERATOR_BE_AS_STATIC_LIBS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"
...
CPP=cl.exe
CPP_COMMON=/nologo /O2 /W3 /EHs /MD /GR /D NDEBUG /D WIN32 /D _WINDOWS /D GENERATOR_BE_AS_STATIC_LIBS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"
