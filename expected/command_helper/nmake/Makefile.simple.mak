...
"otherJC.cpp" "otherJC.h" "otherJS.cpp" "otherJS.h" "SomeSortOfTypedefHelper.java" "SomeSortOfTypedefHelper.java" : $(SOURCE)  "simpleJC.h" "$(IDL2JNI_ROOT)\bin\idl2jni.exe"
	<<tempfile.bat
	@echo off
