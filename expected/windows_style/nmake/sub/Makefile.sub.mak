...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHs /Zi /MDd /GR /Gy /Fd"$(INTDIR)/" /I ".." /D _DEBUG /D WIN32 /D _CONSOLE /D BASIC_AS_STATIC_LIBS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /O2 /W3 /EHs /MD /GR /I ".." /D NDEBUG /D WIN32 /D _CONSOLE /D BASIC_AS_STATIC_LIBS /FD /c
CPP_PROJ=$(CPP_COMMON) /Fo"$(INTDIR)\\"
