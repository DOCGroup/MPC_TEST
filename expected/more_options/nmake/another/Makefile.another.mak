...
!ELSE
	$(DEPGEN) -D_DEBUG -DWIN32 -D_WINDOWS -f "Makefile.another.dep" "zzz.cpp"
!ENDIF
...
!IF "$(DEPGEN)" == ""
	...
	@echo http://www.ociweb.com/products/mpc/down.html
!ELSE
	$(DEPGEN) -DNDEBUG -DWIN32 -D_WINDOWS -f "Makefile.another.dep" "zzz.cpp"
!ENDIF
...
CPP=cl.exe
CPP_COMMON=/Zc:wchar_t /nologo /Ob0 /W3 /Gm /EHsc /Zi /GR /Gy /MDd /Fd".\anothersd.pdb" /D _DEBUG /D WIN32 /D _WINDOWS  /FD /c
...
"$(INTDIR)\zzz.obj" : $(SOURCE)
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\zzz.obj" $(SOURCE)
